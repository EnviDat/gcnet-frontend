...
<!--} from "../chartData/detailChartTemperature";-->
<!--import {-->
<!--    createJSONDataset,-->
...
<!--      const fileName = "0temp.json"-->
<!--      this.currentFileLoading = fileName;-->

<!--      // add the timestamp to prevent server side caching-->
<!--      // const url = process.env.NODE_ENV === 'production' ? `${this.baseurl}${fileName}?t=${Date.now()}` : `./testdata/${fileName}`;-->
<!--      const url = "https://www.wsl.ch/gcnet/data/0temp.json"-->
...
<!--      dataCall.get(url)-->
<!--      .then(response => {-->
<!--        that.handleResponse(that, response.data);-->
<!--      })-->
<!--      .catch(error => {-->
...
<!--    handleResponse(vueInstance, data){-->
<!--      if (vueInstance.currentFileLoading === "0temp.json") {-->
<!--          vueInstance.fullData = data;-->

<!--          // vueInstance.useShortFile = false;-->
<!--          vueInstance.fillChart(vueInstance, vueInstance.fullData);-->
<!--      } else if (vueInstance.currentFileLoading === "0temp.json") {-->
...
<!--      try {-->
<!--        let chart = createLineChartTemperature('chartdiv', vueInstance.dateFormat, jsonRecords, vueInstance.weatherGraphs, vueInstance.groupData);-->
...
<!--      try {-->
<!--        let chart = createLineChartTemperature('wchartdiv', vueInstance.dateFormat, jsonRecords, vueInstance.windGraphs, vueInstance.groupData);-->
...
<!--    baseurl: 'https://www.wsl.ch/gcnet/data/0temp.json',-->
<!--    currentFileLoading: '',-->
<!--    dataError: '',-->
<!--    loadRecentData: true,-->
