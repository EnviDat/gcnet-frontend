...
//       fileObjects: [
//         { fileName: 'temp.json', chartTitle: 'Air temperatures', numberFormat: '##  °C', dateFormatTime: false, shortTerm: false, dataParameter: 'temp'},
//         { fileName: 'temp_v.json', chartTitle: 'Air temperatures', numberFormat: '##  °C', dateFormatTime: true, shortTerm: true, dataParameter: 'temp'},
//         { fileName: 'rh.json', chartTitle: 'Relative humidity', numberFormat: '##  %', dateFormatTime: false, shortTerm: false, dataParameter: 'rh'},
//         { fileName: 'rh_v.json', chartTitle: 'Relative humidity', numberFormat: '##  %', dateFormatTime: true, shortTerm: true, dataParameter: 'rh'},
...
// ],
      fileObjects: [
        { fileName1: 'temp.json', fileName2: 'temp_v.json', chartTitle: 'Air temperatures', numberFormat: '##  °C', dateFormatTime: false, shortTerm: false, dataParameter: 'temp'},
       // { fileName: 'temp_v.json', chartTitle: 'Air temperatures', numberFormat: '##  °C', dateFormatTime: true, shortTerm: true, dataParameter: 'temp'},
        { fileName1: 'rh.json', fileName2: 'rh_v.json', chartTitle: 'Relative humidity', numberFormat: '##  %', dateFormatTime: false, shortTerm: false, dataParameter: 'rh'},
      //  { fileName: 'rh_v.json', chartTitle: 'Relative humidity', numberFormat: '##  %', dateFormatTime: true, shortTerm: true, dataParameter: 'rh'},
        // { fileName: 'rad.json', chartTitle: 'Radiation', numberFormat: '###  W/m²', dateFormatTime: false},
        // { fileName: 'rad_v.json', chartTitle: 'Radiation', numberFormat: '###  W/m²', dateFormatTime: true},
        // { fileName: 'sheight.json', chartTitle: 'Snow heights', numberFormat: '#.#  m', dateFormatTime: false},
      ...
      generateFileList() {
          ...
          for (let i = 0; i < this.fileObjects.length; i++) {
              let fileObjectTemplate = {
                  ...
                  shortTerm: this.fileObjects[i].shortTerm,
