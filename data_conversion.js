...
/*
    var time2 = new Date(year.toString());

    time2 = dateFns.addDays(time2, days);
    time2 = dateFns.setMinutes(time2, 0);
    time2 = dateFns.setSeconds(time2, 0);
    time2 = dateFns.setHours(time2, hours);
*/
    // console.log("year " + year + " julianDays " + julianDays + " to setDayOfYear" + time + " or to addDays " + time2);
    return time; 
}
